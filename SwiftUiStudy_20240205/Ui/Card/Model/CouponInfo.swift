...
struct CouponInfoResponse: Decodable {
    var id = UUID()
    ...
    init(from decoder: Decoder) throws {
        ...
        couponInfo = (try values.decodeIfPresent(CouponInfo.self, forKey: .couponInfo)) ?? CouponInfo(receivePrice: 0, enuriImgName: "", amtImgName: "", wintImgName: "", enuriCopnRtntQty: 0, amtDitiRtntQty: 0, wintInsmCopnRtntQty: 0)
    }
