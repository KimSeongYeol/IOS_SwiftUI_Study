...
struct CardUseListResponse: Decodable {
    var id = UUID()
    
    var cardUseLise: [CardUseListItem]
    ...
    init(from decoder: Decoder) throws {
        ...
        cardUseLise = (try values.decodeIfPresent([CardUseListItem].self, forKey: .cardUseLise)) ?? []
    }
    
    
    struct CardUseListItem: Decodable {
